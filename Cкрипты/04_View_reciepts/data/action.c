Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=129622.266018631zzzHttfpDAiDDDDDtAAAtpzHVif", ENDITEM, 
		"Name=username", "Value=VUser1", ENDITEM, 
		"Name=password", "Value=VUser1", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=252;761;09/16/2020", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Business", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=firstName", "Value=Sabina", ENDITEM, 
		"Name=lastName", "Value=Mussaeva", ENDITEM, 
